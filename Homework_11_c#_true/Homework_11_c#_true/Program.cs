...
//var list = debtors.Where(x => x.Email.EndsWith("rhyta.com")).ToList();

//foreach (var item in list)
//    Console.WriteLine(item);

//var list = debtors.Where(x => x.Email.EndsWith("dayrep.com")).ToList();
...
//var list = debtors.Where(x => x.BirthDay.Year<=1997 && x.BirthDay.Year>1987).ToList();
...
//var list  = debtors.Where(x => x.Debt <= 5000).ToList();
...
//-------NOTE------
// Verilmish sherte uygun netice olmadigi ucun console'a hecne cixmir

//var list = debtors.Where(x => x.FullName.Length > 18 && x.Phone.Count(x => x == '7') >= 2).ToList();
...
//{
//    orta_borc += debtors[i].Debt;
//}
//orta_borc = orta_borc / debtors.Count();

//var list = debtors.Where(x => x.Debt > orta_borc).ToList();
////---Meblegin azalmasina gore--//
////var sorted_list = list.OrderBy(x => x.Debt).ToList();
////sorted_list.Reverse();
////foreach (var item in sorted_list)
////    Console.WriteLine(item);

////---Fullname'e gore---//
//var sorted_list = list.OrderBy(x => x.FullName).ToList();
...
//var list = debtors.Where(x => !x.Phone.Contains('8')).ToList();

//for (int i = 0; i < list.Count; i++)
//{
//    Console.WriteLine("Fullname: " + list[i].FullName);
//    Console.WriteLine("Age: " + (2023 - list[i].BirthDay.Year));
//    Console.WriteLine("Debt: " + list[i].Debt);
//}
...
//for (int i = 0; i < debtors.Count(); i++)
//{
//    int say_1 = debtors.Count(x => x.BirthDay.Year == debtors[i].BirthDay.Year);

//    if (say_1 > say)
//    {
//        say = say_1;
//        en_cox = debtors[i].BirthDay.Year;
//    }
//}

//Console.WriteLine(en_cox);

//14)Borcu en boyuk olan 5 borclunun siyahisini cixartmaq

//var list = debtors.OrderBy(x => x.Debt).ToList();
//list.Reverse();
...
//for (int i = 0; i < debtors.Count(); i++)
//{
//    obsi_borc += debtors[i].Debt;
//}

//Console.WriteLine(obsi_borc);

//16)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq

//var list = debtors.Where(x => x.BirthDay.Year < 1945).ToList();
...
var list = debtors.Where(x => x.FullName.Contains("s") && x.FullName.Contains("m") && x.FullName.Contains("i") && x.FullName.Contains("l") && x.FullName.Contains("e")).ToList();
